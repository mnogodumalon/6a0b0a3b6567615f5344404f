...
export function EintraegeDialog({ open, onClose, onSubmit, defaultValues, kategorienList, enablePhotoScan = true, enablePhotoLocation = true }: EintraegeDialogProps) {
